...
<link rel="icon" type="image/jpg" href="img/tools.jpg">
    ...
    <!-- Favicon -->
    <link href="img/tools.jpg" rel="icon">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div class="nav-item dropdown">
                    <a href="#"
                        ...
                        data-bs-toggle="dropdown">Sign In<i class="bi bi-box-arrow-left"></i></a>
                    <div class="dropdown-menu rounded-0 m-2 bg-primary">
                        <a href="./login/loginseeker.html" class="dropdown-item bg-primary text-white">Job Seeker</a>
                        <a href="./login/loginworker.html" class="dropdown-item bg-primary text-white">Job Wanter</a>
                    </div>
                </div>
